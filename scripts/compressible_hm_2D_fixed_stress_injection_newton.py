...
shear_modulus = Constant(shear_modulus_value)       # módulo de cisalhamento em Pa; mede a resistência da rocha à deformação por cisalhamento
...
def midheight_profile(pressure, sigma_total, source):  # perfil no meio do reservatório, 
